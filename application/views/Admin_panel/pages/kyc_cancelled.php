...
<table class="table table-hover">
        ...
        if($table_data){
            ...
            <tr>
                ...
                <td><?php if($t_data['bank_kyc_status']=='rejected'){ ?><a class="btn btn-sm btn-info" href="<?= $admin_path.'kyc/view?id='.$t_data['id'];?>">View</a><?php } ?></td>                               
                <td><?php if($t_data['adhaar_kyc_status']=='rejected'){ ?><a class="btn btn-sm btn-info" href="<?= $admin_path.'kyc/view?id='.$t_data['id'];?>">View</a><?php } ?></td>                              
                <td><?php if($t_data['pan_kyc_status']=='rejected'){ ?><a class="btn btn-sm btn-info" href="<?= $admin_path.'kyc/view?id='.$t_data['id'];?>">View</a><?php } ?></td>                           
