...
<table class="table table-hover">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <a href="<?= $t_data->bank_img;?>" target="_blank">
        <img src="<?= $t_data->bank_img;?>" style="height:300px;width:300px">
        </a>
        <br>
        ...
        <form action="" method="post">
            ...
            <input type="text" class="form-control" name="bank_name" value="<?= $t_data->bank_name;?>" >
            <input type="text" class="form-control" name="account_holder_name" value="<?= $t_data->account_holder_name;?>" >
            <input type="text" class="form-control" name="account_no" value="<?= $t_data->account_no;?>" >
            <input type="text" class="form-control" name="ifsc_code" value="<?= $t_data->ifsc_code;?>" >
            <input type="text" class="form-control" name="bank_branch" value="<?= $t_data->bank_branch;?>">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        ...
        <form action="" method="post">
            <div class="form-group">
             ...
             <input type="text" name="pan_no"  class="form-control" value="<?= $t_data->pan_no;?>" >
             <input type="text" name="pan_name"  class="form-control"  value="<?= $t_data->pan_name;?>">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        ...
        <form action="" method="post">
            <div class="form-group">
             ...
             <input type="text" name="adhaar_name"  class="form-control"  value="<?= $t_data->adhaar_name;?>">
             <input type="text" name="adhaar_no"  class="form-control"  value="<?= $t_data->adhaar_no;?>">
