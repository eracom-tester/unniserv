...
<!-- Start wrapper-->
 ...
 <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu text-uppercase">
	...
	<?php
      ...
      <li>
		...
		<?php  if($this->conn->plan_setting('investment')==1){  ?>
          <li><a href="<?= $panel_path.'invest/investment';?>" target="_blank"><i class="zmdi zmdi-dot-circle-alt"></i> Topup</a></li>
		   <?php } ?>
            <?php  if($this->conn->plan_setting('reinvestment')==1){  ?>
          <li><a href="<?= $panel_path.'invest/reinvestment';?>" target="_blank"><i class="zmdi zmdi-dot-circle-alt"></i> Re-Topup</a></li>
          <?php } ?>
        </ul>
       </li>
        <?php } ?>
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
                <?php  if($profile->img!=''){?>
                             <div class="avatar"><img class="align-self-start mr-3" src="<?=  base_url('images/user/')?><?= $this->session->userdata('profile')->img;?>"></div>
                                <?php }else{ ?>
    						<div class="avatar"><img class="align-self-start mr-3" src="<?=  $this->conn->company_info('logo');?>"></div>
    							<?php } ?>
