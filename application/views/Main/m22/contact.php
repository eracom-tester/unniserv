...
.bc:hover{
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="contact-info-box">
                            ...
                            <h3>Our Address</h3>
                            <p><?php echo $this->conn->company_info('company_address');?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="contact-info-box">
                            ...
                            <h3>Contact</h3>
                            <p>Mobile: <?php echo $this->conn->company_info('company_mobile');?></p>
                            <p>E-mail: <?php echo $this->conn->company_info('company_email');?></p>
                        </div>
                    </div>
        ...
        <section class="contact-area pb-100">
            <div class="container">
                <div class="section-title">
                    <span class="sub-title"><img src="<?= $panel_url;?>assets/img/star-icon.png" alt="image"> Get in Touch</span>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="contact-image" data-tilt>
                            <img src="<?= $panel_url;?>assets/img/contact.png" alt="image">
                        </div>
                    </div>
        ...
        <!-- Start Map Area -->
        <div id="map">
           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3455.7682945328247!2d76.58645021511376!3d29.98608828190356!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390e25a620fc56d3%3A0x6d936a7196716861!2sCapitalwebapps!5e0!3m2!1sen!2sin!4v1527754485375" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
        <!-- End Map Area -->
