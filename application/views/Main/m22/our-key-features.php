...
<head>
        ...
        <title>MLM Ready Made | About us | Multi Level Marketing software</title>
        
        <meta name="description" content="Providing MLM Software & Services across India. All MLM Solutions like MLM Software, Android App, Consultation, Script  Website, Data Shifting, under one roof." />
...
.bc:hover{
    ...
    <body>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a href="#" class="nav-link">About Us <i class='bx bx-chevron-down'></i></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a href="<?= base_url();?>work-process" class="nav-link">Work Process</a></li>
                                        
                                        <li class="nav-item"><a href="<?= base_url();?>our-key-features" class="nav-link">Our Key Features</a></li>
        ...
        <section class="page-title-area" style="background-image: url('<?= $panel_url;?>assets/img/ser-1.jpg');">
            <div class="container">
                <div class="page-title-content text-center">
                    <h1>Our Key Features</h1>
                    <ul>
                        <li><a href="<?= base_url();?>index">Home</a></li>
                        <li>Our Key Features</li>
                    </ul>
                </div>
            </div>
        ...
        <section class="services-area pt-100 pb-70 bg-f1f8fb">
            <div class="container">
                <div class="section-title">
                    <span class="sub-title"><img src="<?= $panel_url;?>assets/img/star-icon.png" alt="image"> <?php echo $this->conn->company_info('company_name');?></span>
                    <h2>Our Key Features<span class="overlay"></span></h2>
                    <p>Features have its significance in each and every community advertising software, as it tends to be the standards for selecting a software that fits your advertising business. Our MLM Software is entirely packed with all superior aspects required to begin an affiliate advertising business. The elements and compensation regulations can be custom-made to meet the company's enterprise strategy. Let's see the key facets of our multi stage advertising software program aside from the customized options.</p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-services-item-box wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="icon">
                                <img src="<?= $panel_url;?>assets/img/services/icon1.png" alt="image">
                            </div>
                            <h3>E-Wallet</h3>
                            <p>An digital Wallet or a digital pockets which offers with the digital money. All the incomes will be deposited in this wallet. The e-wallet stability can be used to purchase merchandise and services.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-services-item-box wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                            <div class="icon">
                                <img src="<?= $panel_url;?>assets/img/services/icon2.png" alt="image">
                            </div>
                            <h3>Genealogy Tree</h3>
                            <p>The first-class and easy way to symbolize the hierarchical relation of participants with up traces and down lines. We furnish you a simplified tree view the place the customers can discover the network.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-services-item-box wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                            <div class="icon">
                                <img src="<?= $panel_url;?>assets/img/services/icon5.png" alt="image">
                            </div>
                            <h3>Member Management</h3>
                            <p>Our MLM system affords the commercial enterprise group to control the member, get entry to control, IP-blocking, blocking off & unblocking of members. Member line-up is as a consequence now manageable.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-services-item-box wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="icon">
                                <img src="<?= $panel_url;?>assets/img/services/icon6.png" alt="image">
                            </div>
                            <h3>Reports And Statistics</h3>
                            <p>Track income, expense, commercial enterprise reviews, and profitability, the usage of our on-line MLM Software transactions reviews & graphical data insights. Both enterprise & clients have get admission to to such set of reports.</p>
                        </div>
                    </div>
					<div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-services-item-box wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="icon">
                                <img src="<?= $panel_url;?>assets/img/services/icon3.png" alt="image">
                            </div>
                            <h3>E-Commerce Integrations</h3>
                            <p>Most of the Affiliate advertising and marketing enterprise is related with the promoting of the product & services. The <?php echo $this->conn->company_info('company_name');?> Multi-level advertising and marketing software program is succesful of integrating with any E-commerce system.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-services-item-box wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="icon">
                                <img src="<?= $panel_url;?>assets/img/services/icon4.png" alt="image">
                            </div>
                            <h3>Internationalization</h3>
                            <p>"Network Marketing" is a international business, & clients can be part of from special areas & countries. For patron & enterprise team’s convenience, our returned workplace software program helps a couple of languages and currencies.</p>
                        </div>
                    </div>
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-services-item-box wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                            ...
                            <p>The enterprise crew can promote the commercial enterprise by way of developing advertising and marketing campaigns and desirable discounts. We grant special campaigning and sweep-take selections in our multi level marketing structures to meet the enterprise targets.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-services-item-box wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            ...
                            <h3>Configurable</h3>
                            <p>Almost the entirety in our community advertising and marketing software program is configurable! The pay plan,downline members, upline members, MLM leads, distributors, leaders, sponsors, dynamic compressions, payouts, and nearly the whole thing in the system.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="projects-area bg-color pt-100 pb-70">
            <div class="container">
                <div class="section-title">
                    <span class="sub-title"><img src="<?= $panel_url;?>assets/img/star-icon.png" alt="image"> Recent Projects</span>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-projects-box wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="<?= $panel_url;?>assets/img/projects/img1.jpg" alt="image">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-projects-box wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="<?= $panel_url;?>assets/img/projects/img2.jpg" alt="image">

                                <a href="#" class="link-btn"><i class='bx bx-plus'></i></a>
                            </div>

                            <div class="content">
                                <h3><a href="#">Customer Segmentation</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-projects-box wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="<?= $panel_url;?>assets/img/projects/img3.jpg" alt="image">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-projects-box wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="<?= $panel_url;?>assets/img/projects/img4.jpg" alt="image">

                                <a href="#" class="link-btn"><i class='bx bx-plus'></i></a>
                            </div>

                            <div class="content">
                                <h3><a href="#">Detection Project</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-projects-box wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="<?= $panel_url;?>assets/img/projects/img5.jpg" alt="image">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-projects-box wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="<?= $panel_url;?>assets/img/projects/img6.jpg" alt="image">

                                <a href="#" class="link-btn"><i class='bx bx-plus'></i></a>
                            </div>

                            <div class="content">
                                <h3><a href="#">Benefits Research</a></h3>
        ...
        <section class="membership-levels-area ptb-100">
            <div class="container">
                <div class="section-title">
                    <span class="sub-title"><img src="<?= $panel_url;?>assets/img/star-icon.png" alt="image"> Pricing</span>
        ...
        <section class="testimonials-area pt-100 bg-f1f8fb">
            <div class="container">
                <div class="section-title">
                    <span class="sub-title"><img src="<?= $panel_url;?>assets/img/star-icon.png" alt="image"> Testimonials</span>
                    <h2>What Our Clients are Saying?<span class="overlay"></span></h2>
                    <p>We value our customers, and their opinions be counted the most! <?php echo $this->conn->company_info('company_name');?> Solutions definitely bought a Talented crew of professional engineers, I am the use of <?php echo $this->conn->company_info('company_name');?> binary MLM design for extra than four years. I am very an awful lot cosy with the crew and software program is doing its job wonderfully.</p>
                </div>

                <div class="testimonials-slides owl-carousel owl-theme">
                    <div class="single-testimonials-item">
                        <p>They truly did an liked job<br>
Sukhbir Singh CEO-<?php echo $this->conn->company_info('company_name');?><br>
I definitely admire the MLM Solutions that <?php echo $this->conn->company_info('company_name');?> Solutions offer. Besides, I additionally admire the fine output, problem-solving skills and the precision of execution that this business enterprise presents within the detailed time limit.</p>
                        <div class="client-info">
                            <div class="d-flex justify-content-center align-items-center">
                                <img src="<?= $panel_url;?>assets/img/testimonials/img1.jpg" alt="image">
                                <div class="title">
                                    <h3>Narayan Sethi</h3>
                                    <span>Client</span>
                                </div>
                    ...
                    <div class="single-testimonials-item">
                        <p> <?php echo $this->conn->company_info('company_name');?> Solutions used to be cautioned via a pal of mine. I wanted anybody to get worried with an current MLM project. I used to be amazed how shortly <?php echo $this->conn->company_info('company_name');?> Team had been in a position to draw close the multilevel marketing layout ideas used to make this software a reality.</p>
                        <div class="client-info">
                            <div class="d-flex justify-content-center align-items-center">
                                <img src="<?= $panel_url;?>assets/img/testimonials/img2.jpg" alt="image">
                                <div class="title">
                                    <h3>Vishal Verma</h3>
                                    <span>Client</span>
                                </div>
                    ...
                    <div class="single-testimonials-item">
                        <p><?php echo $this->conn->company_info('company_name');?> the quality MLM Software enterprise gives you an special listing of 4 vital offerings that will decorate your multi degree advertising commercial enterprise to an Enterprise level.</p>
                        <div class="client-info">
                            <div class="d-flex justify-content-center align-items-center">
                                <img src="<?= $panel_url;?>assets/img/testimonials/img3.jpg" alt="image">
                                <div class="title">
                                    <h3>Amrike Singh</h3>
                                    <span>Client</span>
                                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 col-6 col-sm-4 col-md-4">
                        <div class="single-partner-item wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <img src="<?= $panel_url;?>assets/img/partner/img1.png" alt="image">
                        </div>
                    </div>

                    <div class="col-lg-2 col-6 col-sm-4 col-md-4">
                        <div class="single-partner-item wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                            <img src="<?= $panel_url;?>assets/img/partner/img2.png" alt="image">
                        </div>
                    </div>

                    <div class="col-lg-2 col-6 col-sm-4 col-md-4">
                        <div class="single-partner-item wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <img src="<?= $panel_url;?>assets/img/partner/img3.png" alt="image">
                        </div>
                    </div>

                    <div class="col-lg-2 col-6 col-sm-4 col-md-4">
                        <div class="single-partner-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <img src="<?= $panel_url;?>assets/img/partner/img4.png" alt="image">
                        </div>
                    </div>

                    <div class="col-lg-2 col-6 col-sm-4 col-md-4">
                        <div class="single-partner-item wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                            <img src="<?= $panel_url;?>assets/img/partner/img5.png" alt="image">
                        </div>
                    </div>

                    <div class="col-lg-2 col-6 col-sm-4 col-md-4">
                        <div class="single-partner-item wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <img src="<?= $panel_url;?>assets/img/partner/img6.png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="blog-area pt-100 pb-70 bg-fffbf5">
            <div class="container">
                <div class="section-title">
                    ...
                    <p>Give your business a new shift with the leading MLM software providers. MLM Ready Made has already verified its flexibility, security, and extensibility qualifying it for a huge array of initiatives such as</p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-post wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="post-image">
                                <a href="#">
                                    <img src="<?= $panel_url;?>assets/img/blog/banner5.png" alt="image">
                                </a>
                            </div>
                            ...
                            <div class="post-content">
                                <!-- <ul class="post-meta d-flex justify-content-between align-items-center">
                                    <li>
                                        <div class="post-author d-flex align-items-center">
                                            <img src="<?= $panel_url;?>assets/img/user1.jpg" class="rounded-circle" alt="image">
                                            <span></span>
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <h3 class="bc">High-traffic, high-security, high-profile sites</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-post wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                            <div class="post-image">
                                <a href="#">
                                    <img src="<?= $panel_url;?>assets/img/blog/banner6.png" alt="image">
                                </a>
                            </div>
                            ...
                            <div class="post-content">
                                <!-- <ul class="post-meta d-flex justify-content-between align-items-center">
                                    <li>
                                       <div class="post-author d-flex align-items-center">
                                            <img src="<?= $panel_url;?>assets/img/user2.jpg" class="rounded-circle" alt="image">
                                            <span> </span>
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <h3 class="bc">Multisite platforms at the state and local government level</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                        <div class="single-blog-post wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="post-image">
                                <a href="#">
                                    <img src="<?= $panel_url;?>assets/img/blog/banner4.png" alt="image">
                                </a>
                            </div>
                            ...
                            <div class="post-content">
                                <!--<ul class="post-meta d-flex justify-content-between align-items-center">
                                    <li>
                                        <div class="post-author d-flex align-items-center">
                                            <img src="<?= $panel_url;?>assets/img/user3.jpg" class="rounded-circle" alt="image">
                                            <span> </span>
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <h3 class="bc">Templated site-building platforms for institutions</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="project-start-image">
                            <img src="<?= $panel_url;?>assets/img/our-mission/banner2.png" data-speed="0.06" data-revert="true" alt="image">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="project-start-content">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">Develop, promote & earn! Adapt the new digital platform developed through our builders particularly for e-commerce, woo-commerce etc.</p>
                            <a href="<?= base_url();?>contact" class="default-btn wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms"><i class="flaticon-web"></i>Get Started<span></span></a>
                        </div>
                    </div>
                </div>
            </div>

            <div class="circle-shape1"><img src="<?= $panel_url;?>assets/img/shape/circle-shape1.png" alt="image"></div>
        </section>
