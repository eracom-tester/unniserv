<?php
$plan=$_GET['plan'];
$this->session->set_userdata('reg_plan',$plan);
?>
...
<head>
       ...
       <link rel="canonical" href="<?= base_url();?>plan-login" />
                        ...
                        <div class="login-form">
                            ...
                            <form action="<?= base_url();?>login" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" class="form-control" placeholder="Username or email " value="demo">
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 lost-your-password-wrap">
                                        <a href="<?= base_url();?>forgot" class="lost-your-password">Lost your password?</a>
                                    </div>
                                </div>
