...
<head>
        ...
        <title>RD FD Software Development | Best Mini Banking Software</title>
        
        <meta name="description" content="RD FD Software - A Mini Banking Software. We are RD-FD Software Development Company Provide fully Featured of RD-FD Software, Mini Banking Software." />
       <link rel="canonical" href="<?= base_url();?>rd-fd-software" />
...
.bc:hover{
    ...
    <body>
        ...
        <section class="page-title-area">
            <div class="container">
                <div class="page-title-content">
                    <h2>RD FD Software</h2>
                    <ul>
                        <li><a href="<?= base_url();?>index">Home</a></li>
                        <li>RD FD Software</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
		<h2>RD FD Software - A Mini Banking Software</h2>
        <p>The RD (Recurring Deposit) FD (Fixed Deposit) Institutions are these who takes deposits and the people and provides the loans.</p>
		<p>In RD (Recurring Deposit) the people deposits a sum of amount to the establishments on daily, weekly or month-to-month basis and after a fixed time he/she returned a matured amount with interest to the depositor.</p>
		<p>In FD (Fixed Deposit) the person deposit a sum of amount for a fixed time of duration consider for 5 years. After 5 years the FD grow to be mature and he/she returned with interest.</p>
		<p></p>
		</div>
		<p>&nbsp;</p>
		<!--<p>&nbsp;</p>-->
        ...
        <!-- Start Our Mission Area -->
            <div class="container">
                            <div class="content">
                                <h2>Why Financial Companies need a Software for RD-FD Management?</h2>
								<p><b>An institution can begin RD FD business and control all the transactions of deposits. To control all these transactions, due installments of RD, maturity date of RD and FD all such variety of managerial tasks can't control manually.</b></p>
								
								<h3><?php echo $this->conn->company_info('company_name');?> offers RD FD Software to control all kind of transactions in this regard with following features:</h3>
								
								<ul>
								<li>Easy RD FD management system</li>
								<li>Penalty calculation</li>
								<li>RD installment due</li>
								<li>Easy to deposit Installment</li>
								<li>Important Reports of RD and FD</li>
								<li>Maturity list</li>
								<li>Upcoming due installment of RD</li>
								<li>Bond printing for Fixed Deposit</li>
								<li>Receipt print for RD FD deposits</li>
								<li>All required reports to manage RD FD transactions and many more</li>
								
								
								<h3><?php echo $this->conn->company_info('company_name');?> Provides Full Featured RD-FD Software - Easy RD FD Management System</h3>
