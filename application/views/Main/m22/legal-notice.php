...
<head>
       ...
       <link rel="canonical" href="<?= base_url();?>legal-notice" />
...
.bc:hover{
    ...
    <body>
        ...
        <div class="container">
		<h2>Legal Information</h2>
        <p>The contents, pictures and videos shown on <?php echo $this->conn->company_info('company_name');?> website are provided to visitors and clients so that they can analyze our MLM Software development and plan consultancy services and give us a chance to provide our Software and IT services. <?php echo $this->conn->company_info('company_name');?> is a property of <a href="https://eracom.in/">Eracom Technologies Pvt. Ltd.</a> which is running the website <?php echo $this->conn->company_info('base_url');?>.</p>
		<p>The content material on <?php echo $this->conn->company_info('company_name');?> may also be used for informational functions only. You can also not use any content material of our website for any commercial purpose, retransmit, republish, redistribute or any means without written permission from <?php echo $this->conn->company_info('company_name');?>. By visiting our website you agree to be bound on the following terms and conditions related to use of the website.</p>
		</div>
		<p>&nbsp;</p>
		<!--<p>&nbsp;</p>-->
        ...
        <!-- Start Our Mission Area -->
            <div class="container">
                            <div class="content">
								...
								<p></p>
								<ul>
								<li>Contents, images and videos on <?php echo $this->conn->company_info('company_name');?> are their property and you might also not change or use these for any purpose.</li>
								<li><?php echo $this->conn->company_info('company_name');?> provides the MLM Software and IT solutions for the businesses who prefer to start their MLM business. We also provide the demo for MLM Software, so that our clients can analyze our MLM software program efficiency, features, reliability and layout. You can't attempt to unauthorized get right of entry to to any demo software program or element of our website.</li>
								<li>The software program available for demo or down load on <?php echo $this->conn->company_info('company_name');?> website is the copyrighted work of Corbit Global Solutions Pvt. Ltd.. User simply can go to the facets of MLM Software and can't redistribute or copy to any different individual or company. Software can be used by the user by means of accepting the terms and conditions of the applicable license agreement.</li>
								<li>Unless in any other case stated, <?php echo $this->conn->company_info('company_name');?> website is managed and operated from our head workplace placed at Pehowa. If you take any legal action associated to our website that must be file only in 'Hon'ble High Court Chandigarh ( Haryana & Punjab ) India Jurisdiction.</li>
								<li>We will protect your personal or sensitive information which you submit through our website inquiry form by using encryption and SSL technology.</li>
								<li><?php echo $this->conn->company_info('company_name');?> has its personal privateness policy and may additionally change at any time without giving any notices or prior information.</li>
								</ul>
								<h2></h2>
								<p></p>
								<p></p>
