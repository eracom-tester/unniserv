...
<head>
       ...
       <link rel="alternate" href="https://www.mlmreadymade.com/en/page-a/" hreflang="en-us" />
       ...
       <link rel="canonical" href="https://www.mlmreadymade.com/" />
...
<meta name="twitter:image" content="https://www.mlmreadymade.com/Main/m22/assets/img/our-mission/img4.jpg" />

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-WHRK65SS6B"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-WHRK65SS6B');
</script>
														...
														<li class="submenu-top-item thumb-list">
														  <a href="#" class="submenu-title">DEMO PLANS</a>
															...
															<li>
															  ...
															  <a href="<?= base_url();?>plan-login?plan=single-leg" target="_blank">SINGLE LEG</a>
															</li>
															<!--<li>
