                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="our-mission-content">
                            <div class="content">
                                <h2>All MLM Plans Software</h2>
                                <ul class="features-list">
                                    
                                    <li><i class="flaticon-tick"></i> <a href="binary-plan.php" target="_blank" class="text-muted">BINARY PLAN</a></li>
                                    <li><i class="flaticon-tick"></i> <a href="unilevel-plan.php" target="_blank" class="text-muted">UNILEVEL PLAN</a></li>
                                    <li><i class="flaticon-tick"></i> <a href="matrix-plan.php" target="_blank" class="text-muted">MATRIX PLAN</a></li>
                                    <li><i class="flaticon-tick"></i> <a href="board-plan.php" target="_blank" class="text-muted">BOARD PLAN</a></li>
                                    <li><i class="flaticon-tick"></i> <a href="gift-plan.php" target="_blank" class="text-muted">GIFT PLAN</a></li>
									<li><i class="flaticon-tick"></i> <a href="monoline-plan.php" target="_blank" class="text-muted">MONOLINE PLAN</a></li>
                                    <li><i class="flaticon-tick"></i> <a href="generation-plan.php" target="_blank" class="text-muted">GENERATION PLAN</a></li>
                                    <li><i class="flaticon-tick"></i> <a href="party-plan.php" target="_blank" class="text-muted">PARTY PLAN</a></li>
									<li><i class="flaticon-tick"></i> <a href="stair-plan.php" target="_blank" class="text-muted">STAIR PLAN</a></li>
                                    <li><i class="flaticon-tick"></i> <a href="spillover-plan.php" target="_blank" class="text-muted">SPILLOVER PLAN</a></li>
                                    <li><i class="flaticon-tick"></i> <a href="australian-plan.php" target="_blank" class="text-muted">AUSTRALIAN PLAN</a></li>
									<li><i class="flaticon-tick"></i> <a href="hybrid-plan.php" target="_blank" class="text-muted">HYBRID PLAN</a></li>
                                  </ul>
                            </div>
                        </div>
                    </div>
