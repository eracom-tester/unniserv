...
<div class="row">
    ...
    <?php
                ...
                <span <?php if($node_id){ ?> data-toggle="popover1" data-trigger="hover" data-html="true" data-content="Name :<?= $_user_profile->name;?><br>Sponser Id: <?= $sponsor_details->name;?> (<?= $sponsor_details->username;?>)<br> Email: <?= $_user_profile->email;?><br>Join Date : <?= $_user_profile->added_on;?>" <?php } ?> >
