                ...
                <nav class="navbar navbar-default navbar-mobile navbar-sticky bootsnav">
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class=" " href="<?= base_url();?>index"><img src="<?= $this->conn->company_info('logo');?>" class="logo" style="width:<?= $this->conn->company_info('logo_width');?>;height:<?php echo $this->conn-> company_info('logo_height');?>" alt="<?= $this->conn->company_info('company_name');?>"></a>
                        </div>
          ...
          ?>
            ...
            <?php  if($this->conn->plan_setting('tree')==1){  ?>
                                        <li><a href="<?= $panel_path.'team/team-tree';?>"><i class="fa fa-id-card-o"></i>Tree</a></li>
										  <?php } ?> 
            <?php  if($this->conn->plan_setting('tree')==1){  ?>
                                        <li><a href="<?= $panel_path.'team/team-rank-wise';?>"><i class="fa fa-id-card-o"></i>Rank Wise</a></li>
										  <?php } ?> 
