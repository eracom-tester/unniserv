          ...
          <div class="row">
            ...
            <div class="col-lg-6">                  
              ...
              ?>
                    ...
                    <input type="text" class="form-control input-shadow bg-white" value="<?= $input_sizes;?>" name="tags" id="" placeholder="Enter Size" />
...
<center>
  <button type="submit" class="btn btn-primary btn-sm">Save</button>
        ...
        <form action="" id="main_image_form" method="post" enctype="">
              ...
              <img id="p_main_image" src="<?= base_url().'images/products/'.$product_detail->imgs;?>" style="width:100%;">            
